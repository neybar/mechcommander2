// Vulkan port of shaders/include/scene.hglsl — SceneData UBO at set 0
// binding 4 (C++ side: SCENE_DATA_ATTACHMENT_SLOT=1 -> descriptor binding 4)
#ifndef SCENE_GLSL_INCLUDED
#define SCENE_GLSL_INCLUDED
